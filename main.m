...
%% -----------------读文件--------------------
data_complex=read_complex_binary('915mhz_sp3.2mhz');
%% 
data_complex=data_complex(32e6:100e6);
%% -----------------分别取实部(I)与虚部(Q)-----------------
...
preamble_test=data_complex(59.315600e6:59.318800e6-1,1);
%% 
...
%% 
figure(5)
plot(real(data_complex(46008231:46008231+3200-1)));
